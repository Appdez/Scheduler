            ...
            <div class="content-side">
                <ul class="nav-main">
                    ...
                    @hasanyrole('admin|atendente|cliente')
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('client_scheduler*') ? ' active' : '' }}"
                    ...
                    @hasanyrole('admin')
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('schedule_service*') ? ' active' : '' }}"
                                href="{{ route('schedule_service.index') }}">
                                <i class="nav-main-link-icon si si-anchor"></i>
                                <span class="nav-main-link-name">Adicionar serviços</span>
                            </a>
                        </li>
                    @endhasallroles
                    @hasanyrole('admin')
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('document*') ? ' active' : '' }}"
