                            ...
                            <tr>
                                ...
                                <td class="d-none d-sm-table-cell font-size-sm">
                                    <a href="{{ route('document.edit', $document->id) }}"
                                        class="btn btn-alt-warning shadow-sm">Editar</a>
                                </td>
                                <td class="d-none d-sm-table-cell">
                                    <button class="btn   btn-alt-danger shadow-sm"
                                        onclick="document.getElementById('Delete_{{ $document->id }}').submit()">Deletar</button>
                                    <form action="{{ route('document.destroy', $document->id) }}" method="post"
                                        id="Delete_{{ $document->id }}"> @csrf
                                        @method('DELETE')</form>
                                </td>
                            </tr>
                        @endforeach
